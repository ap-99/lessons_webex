...
for(var i=0; i<box.length; i++){
 ...
 box[i].appendChild(change_lesson);
 ...
 box[i].appendChild(remove_lesson);
}
...
if(localStorage["mail0"]){var mail0=localStorage["mail0"];document.getElementById("mail0").value=mail0;document.getElementById("mail0_link").href="mailto:"+mail0;document.getElementById("mail0_link").style.pointerEvents="auto";}
...
if(localStorage["mail11b"]){var mail11b=localStorage["mail11b"];document.getElementById("mail11b").value=mail11b;document.getElementById("mail11b_link").href="mailto:"+mail11b;document.getElementById("mail11b_link").style.pointerEvents="auto";}
...
if(localStorage["mail13"]){var mail13=localStorage["mail13"];document.getElementById("mail13").value=mail13;document.getElementById("mail13_link").href="mailto:"+mail13;document.getElementById("mail13_link").style.pointerEvents="auto";}

editBtn3.addEventListener("click", function(e)
{
 var mail0=document.getElementById("mail0").value;localStorage.setItem("mail0", mail0);
 ...
 var mail11b=document.getElementById("mail11b").value;localStorage.setItem("mail11b", mail11b);
 var mail12=document.getElementById("mail12").value;localStorage.setItem("mail12", mail12);
 var mail13=document.getElementById("mail13").value;localStorage.setItem("mail13", mail13);
